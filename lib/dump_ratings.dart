...
import 'package:uspsa_result_viewer/data/ranking/elo_ranker.dart';
...
void dumpRatings() async {
  ...
  var extraFastRankings = Ranker(matches: matches, ratingSystem: EloRanker(), byStage: true, filters: FilterSet(empty: true)
    ..mode = FilterMode.or
    ..divisions = {
      Division.open: true,
      Division.pcc: true,
