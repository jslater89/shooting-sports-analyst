...
class LoadingDialog<T> extends StatefulWidget {
  ...
  static Future<T?> show<T>({
    ...
    required Future<T> waitOn,
    String title = "Loading...",
    ProgressModel? progressProvider,
    bool useRootNavigator = false,
  }) async {
    var result = await showDialog<T>(context: context, useRootNavigator: useRootNavigator, barrierDismissible: false, builder: (context) {
