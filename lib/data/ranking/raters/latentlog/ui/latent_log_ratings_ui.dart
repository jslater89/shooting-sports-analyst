      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: _varianceFlex, child: Text(rating.displayCurrentVariance.toStringAsFixed(2), textAlign: TextAlign.end)),
            Expanded(flex: _volatilityFlex, child: Text(rating.displayVolatility.toStringAsFixed(3), textAlign: TextAlign.end)),
