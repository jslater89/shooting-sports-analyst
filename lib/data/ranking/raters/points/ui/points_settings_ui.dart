    ...
    _participationController.addListener(() {
      if (_participationController.text.length > 0) {
        ...
        if (newBonus != null) {
          ...
          _participationController.text = newBonus.toString();
        }
    ...
    _decayFactorController.addListener(() {
      if (_decayFactorController.text.length > 0) {
        ...
        if (newFactor != null) {
          ...
          _decayFactorController.text = newFactor.toString();
        }
        ...
        Row( // participation bonus
          ...
          children: [
            Tooltip(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(left: 16),
                  child: Text("Participation bonus"),
                )
            ),
            SizedBox(
              width: 100,
